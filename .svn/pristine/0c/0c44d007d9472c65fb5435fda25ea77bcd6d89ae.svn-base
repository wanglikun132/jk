	...
	<div id="sidebar" class="sidebar">
		...
		<div class="panel">
			...
			<div class="panel-header">
				...
				<div>
						<a href="${ctx}/chat/tostar"
							onclick="linkHighlighted(this)" target="main" id="aa_5">好看的星</a>
				</div>
				<div>
						<a href="${ctx}/chat/toflower"
							onclick="linkHighlighted(this)" target="main" id="aa_5">好看的花</a>
				</div>
