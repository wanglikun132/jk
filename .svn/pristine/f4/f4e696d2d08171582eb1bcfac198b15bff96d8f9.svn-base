...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/insert','_self');">确定</a></li>
...
<div>
	...
	<table id="ec_table" class="tableRegion" width="98%" >
		...
		<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
			...
			<td>${o.amount}</td>
			<td>
				<a href="${ctx}/cargo/contract/toupdatep?id=${o.contractProductId}">[修改]</a>
				<a href="javascript:if(confirm('确实要删除吗?')) location='${ctx}/cargo/contract/deleteProduct?id=${o.contractProductId}&contractId=${contractId}'">[删除]</a>
				<a href="${ctx}/toExtcproduct?contractProductId=${o.contractProductId}">[附件]</a>
			</td>
		</tr>
		</c:forEach>
		</tbody>
